...
import com.fatec.crud_kotlin_estoque.plugins.*
...
fun Application.module() {
    // Configura̵̤es do Supabase (tentativa 1: JVM args/Env Vars)
    ...
    // Fallback absoluto: Ler o arquivo local.properties diretamente (para IntelliJ direto no boṭo de Play)
